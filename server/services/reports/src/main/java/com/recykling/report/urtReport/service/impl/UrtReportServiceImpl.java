...
import com.recykling.report.urtReport.urtAggregatesWithoutOulWeights.repo.AggregatesWithoutOilWeightsRepository;
import com.recykling.report.urtReport.urtReportHistory.repo.UrtReportHistoryRepository;
...
public class UrtReportServiceImpl implements IUrtReportService {
    ...
    private void setupAggregatesWithoutOilWeights(RequestCreateUrtReport request, UrtReport urtReport){
        ...
        request.getAggregatesWithoutOilWeights()
                .forEach(weight -> aggregatesWithoutOilWeights.add(new AggregatesWithoutOilWeights(new Weight(weight), urtReport)));
