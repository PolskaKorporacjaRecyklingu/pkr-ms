...
public class UrtReport extends ReportBase {
    ...
    private Set<Employee> brigade = new HashSet<>();
    ...
    @JoinTable(
            ...
            joinColumns = @JoinColumn(name = "employee_id"),
            inverseJoinColumns = @JoinColumn(name = "urt_report_id"))
    private Set<Employee> leaders = new HashSet<>();
    ...
    @JoinTable(
            ...
            joinColumns = @JoinColumn(name = "employee_id"),
            inverseJoinColumns = @JoinColumn(name = "urt_report_id"))
    private Set<Employee> forkliftOperators = new HashSet<>();
    ...
    private Set<UrtReportHistory> urtReportHistories = new HashSet<>();
    ...
    public static class ReportBuilder{
         ...
         */
        private Set<Employee> findListOfEmployees(List<Long> employeesId, String fieldName){
